...
function load(id,c){
    ...
    // ── سجلات الإجازة ──────────────────────────────────────────────────
    else if(id==="la") h=logTbl('سجل الإجازة السنوية','أ','المادتين ١٢٤ و١٢٥',['تاريخ البدء','الانتهاء','العودة','الأيام','الموافقة','ملاحظات'],21,'la');
    else if(id==="lb") h=logTbl('سجل الإجازة العارضة','ب','المادة ١٢٨',['السبب','تاريخ البدء','العودة','الأيام','الموافقة','ملاحظات'],7,'lb');
