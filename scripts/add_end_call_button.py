...
# Define the updated meetings block
meetings_lines = [
    ...
    "                    endBtn = `<button class=\"bt\" onclick=\"endCallDirectly('${doc.id}')\" style=\"background:var(--no); color:#fff; font-size:13px; margin-right:5px;\"><i class=\"fa fa-stop\"></i> إنهاء</button>`;",
    "                }",
    "                ",
...
if start_idx != -1:
    ...
    print("app.js updated successfully with end buttons and document observer!")
else:
